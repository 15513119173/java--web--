...
<map name="Map">
        ...
        <area shape="poly" coords="313,59,402,45,435,56,406,78,311,90,313,58" href="StuResult?action=stuResultQueryS&ID=${student}">
        <area shape="poly" coords="380,141,508,119,541,139,521,154,385,176" href="student?action=modifyQuery&ID=${student}">
