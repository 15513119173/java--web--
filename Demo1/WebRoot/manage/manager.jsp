...
<table width="92%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="16%"><a href="#" onClick="window.open('manage/manager_add.jsp','','width=292,height=190')">添加管理员信息</a> </td>
  </tr>
</table>
<table width="91%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#67A8DB">
  ...
  <tr>
	...
	<a href="Manager?action=queryPWD<%=bean.getID() %>" name="id" value="">修改</link>
	
	</td>
    <td >&nbsp;
		
	<a href="Manager?action=managerDel<%=bean.getID() %>">删除</link>	
	</td>
  </tr>
  <%} %>
