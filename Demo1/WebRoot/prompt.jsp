...
<form action="/manage/lesson.do?action=selectLesson" method="post" onsubmit="return checkForm(lessonForm)">
 <table width="100%" height="211"  border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="center" valign="top"><input type="submit" styleClass="btn_grey" value="开始考试"/>	
	  </td>
    <td>&nbsp;</td>
  </tr>
</table> 
