...
<table width="778" border="0" align="center" cellspacing="0" cellpadding="0">
        ...
        <td height="30" bgcolor="#EEEEEE" class="tableBorder_thin"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
			  ...
			  <td width="24%" align="right"><img src="Images/m_ico1.gif" width="5" height="9">
			    <link href="/default.jsp" >返回首页</link>&nbsp;</td>
              </tr>
          </table></td>
        </tr>
      <tr>
 ...
 <table width="100%" height="265"  border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="center" valign="top"><input type="button" name="button" styleClass="btn_grey" value="开始考试" onclick="window.opener=null;window.close();window.open('StartExam?action=startExam','','width=786,height=600,scrollbars=1');"/>	
