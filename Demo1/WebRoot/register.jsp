...
<form name="form" action="student?action=studentAdd" method="post" >
  ...
  <tr>
    ...
    <tr>
    <td height="30" align="left" style="padding:5px;">qq邮箱：</td>
    <td align="left">
	 <input type='text' name="mail" size="20"/> *</td>
    </tr>
    <tr>
    <td height="30" align="left" style="padding:5px;">密&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
    <td align="left"><input type='password' id="password1" name="pwd" size="20"/>（密码由6到20位的数字或字母组成） *     </td>
    </tr>
  <tr align="center">
    ...
    <tr>
      ...
      <td><input type='submit' id="submit" styleClass="btn_grey" value="保存" onClick="return checkForm()"/>
        &nbsp;
        <input type='reset' id="reset" styleClass="btn_grey" value="取消"/>
		&nbsp;
		<input type='button' id="button" styleClass="btn_grey" value="返回" onClick="window.location.href='index.jsp'"/>		</td>
    </tr>
</table>
<form>
</td>
