...
<table width="778" border="0" align="center" cellspacing="0" cellpadding="0">
 ...
 <table width="57%"  border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#D2E3E6" bordercolorlight="#FFFFFF">
    ...
    <td width="78%" align="left">
	  <input type="text" id="ID" size="40" name="seekPwd3" readonly="true" value="<%=s.getID()%>"/> <span class="word_orange1"> （只读）</span>	  </td>
    </tr>
    <tr align="center">
    <td width="22%" height="30" align="left" style="padding:5px;">密&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
  
    <td width="78%" align="left">
      <input type="text" id="pwd" size="40" name="seekPwd3" readonly="true" value="<%=s.getPwd()%>"/> <span class="word_orange1"> （只读）</span>	  </td>
    </tr>	
    <tr>
      <td height="65" align="left" style="padding:5px;">&nbsp;</td>
      <td>&nbsp;
		<input type="button" value="返回" class="btn_grey" onClick="window.location.href='index.jsp'"/>		</td>
    </tr>
</table>
</td>
      </tr>
