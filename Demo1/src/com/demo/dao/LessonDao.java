...
public class LessonDao {
    ...
    //查询方法
    public static List query(String studentID) {
    	List lessonList = new ArrayList();
        LessonForm lessonForm1 = null;
        ...
        String sql="SELECT * FROM tb_lesson WHERE ID in(SELECT distinct lessonID FROM " +
        		...
        		" as lessonTaoTi GROUP BY lessonId,taoTiID HAVING COUNT(taoTiID) >0) AND" +
...
//    删除数据
        public static int delete(LessonForm lessonForm) {
        	int flag=0;
